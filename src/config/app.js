...
defaultExport.adminConfig={
  ...
  "fieldsTypes":{
    ...
    "relation":['creator','collection','collection_news','collection_recipe','radios_collection','collection_eventsconference','collection_event','eventsnc_collection','collection_product','collection_venue','collection_product_shopify',"collection_sponsors","collection_speakers"],
    "iconmd":['iconmd'],
    "iconfa":['iconfa'],
    "iconti":['iconti'],
    "iconfe":['icon'],
  ...
  "optionsForRelation":[
    //'collection','collection_news','collection_recipe','radios_collection','collection_eventsconference','collection_event','eventsnc_collection','collection_product','collection_venue'
    {
      ...
      "display": "title",
      "isValuePath": true,
      "key": "collection_sponsors",
      "path": "/APP_NAME_sponsors_collection",
      "produceRelationKey": true,
      "relationJoiner": "-",
      "relationKey": "sponsors_collection",
      "value": "name"
    },
    {
      //Firestore - Native
      "display": "title",
      "isValuePath": true,
      "key": "collection_speakers",
      "path": "/APP_NAME_speakers_collection",
      "produceRelationKey": true,
      "relationJoiner": "-",
      "relationKey": "speakers_collection",
      "value": "name"
    },
    {
        //Firestore - Native
